...
const Form = () => {
  ...
  return (
    <StFrom onSubmit={onSubmitHandler}>
      <TextInput type="date" htmlFor="date" name="date" placeholder={`2024-${month}-01`} />
      <TextInput type="text" htmlFor="item" name="item" placeholder="item" />
      <TextInput type="number" htmlFor="amount" name="amount" placeholder="amount" />
      <TextInput type="text" htmlFor="description" name="description" placeholder="description" />
